...
<head>
    <meta charset="UTF-8">
    <title>{{ __('Bedankt voor het deelnemen!') }}</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0"
                    style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 6px rgba(0,0,0,0.05); padding: 40px;">
                    <tr>
                    ...
                    <tr>
                        <td style="color: #2d3748; font-size: 16px; line-height: 1.6;">
                            <p>{{ __('Hallo, :name', ['name' => $guest->name]) }}</p>
                            <p>{{ __('Bedankt voor het inschrijven voor deze activiteit, In het geval van ziekte of andere redenen kunt u zich met deze knop uitschrijven') }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding: 60px 0 30px 0;">
                            <a href="{{ $deregistrationUrl }}"
                    ...
                    <tr>
                        <td style="color: #4a5568; font-size: 14px; line-height: 1.5; text-align: center;">
                            <p>{{ __('Als de knop hierboven niet werkt, kopieer en plak dan deze link in je browser:') }}</p>
                            <p style="word-break: break-all;">
                                <a href="{{ $deregistrationUrl }}" style="color: #fd9a00;">
                                    {{ $deregistrationUrl }}
                                </a>
                            </p>
                        </td>
